  ...
  static List<Map<String, String>> cards = [
    {
      ...
      "AlbumDescription": "Being in nature, or even viewing scenes of nature, reduces anger, fear, and stress and increases pleasant feelings"
    },
    {
      "AlbumName": "Aesthetic",
      "AlbumPicture":
      ...
      "AlbumDescription": "Every snapshot tells a story of beauty, tranquility, and creativity. Each carefully curated image captures moments of serenity, elegance, and wonder, inviting you to embark on a journey of visual delight."
    },
    {
      "AlbumName": "Animals",
      "AlbumPicture":
    ...
    },
    {
      ...
      "AlbumDescription": "From iconic landmarks to intimate moments, each image tells a unique story, inviting viewers to explore the beauty, complexity, and rhythm of urban environments through a lens of creativity and appreciation for the urban experience."
    },
    {
      "AlbumName": "Travel",
      "AlbumPicture":
    ...
    },
    {
      ...
      "AlbumDescription": "Flower transports listeners to a realm where the ephemeral dance of petals mirrors the rhythms of the human heart. With its ethereal soundscape and soul-stirring narratives, Flower invites you to pause, breathe, and immerse yourself in the transformative power of nature's timeless wonders."
    }
  ];
}
